...
get_header();
$background_image = get_field('project_image', 'option');
?>
                        ...
                        <div class="project-block all mix interior architecture landescape col-lg-4 col-md-6 col-sm-12">
                            <div class="image-box">
                                ...
                                <div class="overlay-box">
                                    <h4><a href="<?php the_permalink($page_id) ?>"><?php echo the_title() ?></a></h4>
                                    <div class="btn-box">
                                        <a href="<?php echo $bg_image ?>" class="lightbox-image" data-fancybox="gallery"><i
                                                class="fa fa-search"></i></a>
                                        <a href="<?php the_permalink($page_id) ?>"><i class="fa fa-external-link"></i></a>
                                    </div>
